...
const abi_Nft = abi4;
const contractAddress_Nft = '0x930a1CD204073753dDA114A39B812c906c0E6F88';
const { config } = usePrepareContractWrite({
  address: contractAddress_Nft,
  abi: abi_Nft,
  functionName: 'mint',
})
const {mintNft} = useContractWrite(config);
  return (
    <>
      <section className="bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
                <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">Battle for the Lens Stats</h1>
